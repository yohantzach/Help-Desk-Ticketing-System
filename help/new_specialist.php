...
<div class="col-lg-12">
	<div class="card">
		<div class="card-body">
			<form action="" id="manage_specialist">
				...
				<div class="row">
					...
					<b class="text-muted">Personal Information</b>
						...
						<div class="form-group">
							<label for="" class="control-label">Problems Handled</label>
							<input type="text" name="problems" class="form-control form-control-sm" required value="<?php echo isset($problems) ? $problems : '' ?>">
						</div>
						<div class="form-group">
							<label class="control-label">Expertise</label>
							<textarea name="expertise" id="" cols="30" rows="4" class="form-control" required><?php echo isset($expertise) ? $expertise : '' ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
...
<script>
	...
	$('#manage_staff').submit(function(e){
		...
		$.ajax({
			url:'ajax.php?action=save_specialist',
			...
			success:function(resp){
				if(resp == 1){
					...
					setTimeout(function(){
						location.replace('index.php?page=specialist_list')
					},750)
				}else if(resp == 2){
