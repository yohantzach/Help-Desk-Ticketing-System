			...
			<form action="" id="manage_staff">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							<label for="" class="control-label">System number</label>
							<input type="text" name="system_no" class="form-control form-control-sm" required value="<?php echo isset($system_no) ? $system_no : '' ?>">
						</div>
						<div class="form-group">
							<label for="" class="control-label">System Name</label>
							<input type="text" name="system_name" class="form-control form-control-sm" required value="<?php echo isset($system_name) ? $system_name : '' ?>">
						</div>
						<div class="form-group">
							<label for="" class="control-label">System Software</label>
							<input type="text" name="software" class="form-control form-control-sm" required value="<?php echo isset($software) ? $software : '' ?>">
						</div>
						<div class="form-group">
							<label for="" class="control-label">License</label>
							<input type="text" name="license" class="form-control form-control-sm" required value="<?php echo isset($license) ? $license : '' ?>">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
						...
						<b class="text-muted">Authentication Credentials</b>
						<div class="form-group">
